...
%                   controlled by the 'Scaling' parameter of IMSHOWPAIR.
%
...
if isSpatiallyReferencedInput
    ...
    h = imshow(result,R_ref,parentArgList{:},'InitialMagnification',500);
else
    % imshowpair(A,B,__)
    h = imshow(result,parentArgList{:},'InitialMagnification',500);
end
